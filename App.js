...
var _user$project$App$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {username: a, password: b, email: c, phno: d, role: e, tags: f, errorMsg: g, screen: h, checkout: i};
	});
var _user$project$App$init = A9(_user$project$App$Model, 'Ajay', '1234', '', '', '', '', '', '1', '');
var _user$project$App$user1 = A9(_user$project$App$Model, 'Ajay', '1234', 'ajay@gmail.com', '+91789654123', 'Tutor', 'Java, C, C++', '', '1', '');
var _user$project$App$user2 = A9(_user$project$App$Model, 'Jeorge', '1234', 'jeorge@gmail.com', '+91789654123', 'Seeker', 'Java', '', '1', '');
var _user$project$App$user3 = A9(_user$project$App$Model, 'Hussain', '1234', 'hussain@gmail.com', '+91789654123', 'Tutor', 'Javascript, HTML, ELM, Haskell', '', '1', '');
var _user$project$App$user4 = A9(_user$project$App$Model, 'Javed', '1234', 'javed@gmail.com', '+918892585434', 'Tutor', 'Python, R', '', '1', '');
var _user$project$App$user5 = A9(_user$project$App$Model, 'Ajith', '1234', 'ajith@udemy.com', '+918852365434', 'Tutor', 'Python, Ruby Rails', '', '1', '');
var _user$project$App$user6 = A9(_user$project$App$Model, 'Smith', '1234', 'smith@udemy.com', '+919652385434', 'Seeker', 'Django, Flask', '', '1', '');
var _user$project$App$user7 = A9(_user$project$App$Model, 'Ritesh', '1234', 'ritesh@edx.com', '+919652365412', 'Seeker', 'Ruby, R, Java', '', '1', '');
	...
	_1: {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$App$user5,
					_1: {
						ctor: '::',
						_0: _user$project$App$user6,
						_1: {
							ctor: '::',
							_0: _user$project$App$user7,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$App$append = function (model) {
	return {ctor: '::', _0: model, _1: _user$project$App$userList};
};
var _user$project$App$appendUser = function (model) {
	return _elm_lang$core$List$isEmpty(
		_user$project$App$append(model)) ? false : true;
};
var _user$project$App$getUser = F2(
	function (models, name) {
		...
		while (true) {
			var _p2 = models;
			if (_p2.ctor === '[]') {
				return A9(_user$project$App$Model, '', '', '', '', '', '', '', '1', '');
			} else {
				var _p3 = _p2._0;
		...
		switch (_p4.ctor) {
			...
			case 'ClickUser':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						checkout: A2(_user$project$App$getUser, _user$project$App$userList, _p4._0).username,
						screen: '3'
					});
			case 'ClickLogIn':
			...
			case 'ClickRegister':
				return A3(_user$project$App$checkUser, _user$project$App$userList, model.username, model.password) ? _elm_lang$core$Native_Utils.update(
					model,
					{errorMsg: 'Username taken.', screen: '0'}) : ((_user$project$App$validateUser(model) && _user$project$App$appendUser(model)) ? _elm_lang$core$Native_Utils.update(
					model,
					{errorMsg: '', screen: '2'}) : _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$App$SetRole = function (a) {
	return {ctor: 'SetRole', _0: a};
};
var _user$project$App$SetEmail = function (a) {
	return {ctor: 'SetEmail', _0: a};
};
var _user$project$App$SetTags = function (a) {
	return {ctor: 'SetTags', _0: a};
};
var _user$project$App$SetPhNo = function (a) {
	return {ctor: 'SetPhNo', _0: a};
};
var _user$project$App$ClickRegister = {ctor: 'ClickRegister'};
var _user$project$App$LogInUserPage = {ctor: 'LogInUserPage'};
var _user$project$App$Home = {ctor: 'Home'};
var _user$project$App$ClickUser = function (a) {
	return {ctor: 'ClickUser', _0: a};
};
var _user$project$App$renderUI = function (model) {
	var showseeker = _elm_lang$core$Native_Utils.eq(model.role, 'Seeker') ? '' : 'hidden';
	var showtutor = _elm_lang$core$Native_Utils.eq(model.role, 'Tutor') ? '' : 'hidden';
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$App$ClickUser(model.username)),
				_1: {ctor: '[]'}
			}
		},
		{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'  (',
								A2(_elm_lang$core$Basics_ops['++'], model.role, ')')))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(showtutor),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Courses : ', model.tags)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Interested In : ', model.tags)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$App$renderUsers = function (models) {
	var ui = A2(_elm_lang$core$List$map, _user$project$App$renderUI, models);
	return A2(
...
var _user$project$App$navbar = function (name) {
	return A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Meet-Ur-Tutor'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$App$Home),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$App$navbar(model.username),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-xs-12 col-md-6'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('row col-xs-12 col-md-12'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _user$project$App$renderUsers(_user$project$App$userList),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _user$project$App$thirdPage = function (model) {
	var member = A2(_user$project$App$getUser, _user$project$App$userList, model.checkout);
	var showtutor = _elm_lang$core$Native_Utils.eq(member.role, 'Tutor') ? '' : 'hidden';
	var showseeker = _elm_lang$core$Native_Utils.eq(member.role, 'Seeker') ? '' : 'hidden';
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(model.checkout),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
...
var _user$project$App$RegisterUserPage = {ctor: 'RegisterUserPage'};
var _user$project$App$SetPassword = function (a) {
	return {ctor: 'SetPassword', _0: a};
};
var _user$project$App$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$App$loginPage = function (model) {
																	...
																	_0: A2(
																		...
																		},
																		{
																			...
																			_1: {
																						...
																						_1: {
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: _elm_lang$html$Html_Attributes$value('Tutor'),
																										_1: {
																											ctor: '::',
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html$text(' Tutor  '),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							_elm_lang$html$Html$input,
...
var _user$project$App$view = function (model) {
	...
	switch (_p5) {
		case '0':
			return _user$project$App$signUpPage(model);
		case '1':
		...
		default:
			return _elm_lang$core$Native_Utils.crashCase(
				'App',
				{
					...
					end: {line: 194, column: 32}
				},
				_p5)('Help');
	}
};
var _user$project$App$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$App$init, view: _user$project$App$view, update: _user$project$App$update})();
var _user$project$App$Three = {ctor: 'Three'};
var _user$project$App$Two = {ctor: 'Two'};
var _user$project$App$One = {ctor: 'One'};
