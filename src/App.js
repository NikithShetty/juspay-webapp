		...
		switch (_p0.ctor) {
			...
			case 'ClickRegisterUser':
				return _elm_lang$core$Native_Utils.update(
					...
					{errorMsg: ''});
			case 'ClickLogIn':
				return (_elm_lang$core$Native_Utils.eq(model.username, 'Ajay') && _elm_lang$core$Native_Utils.eq(model.password, '1234')) ? _elm_lang$core$Native_Utils.update(
					model,
					{errorMsg: '', screen: '2'}) : _elm_lang$core$Native_Utils.update(
					model,
					{errorMsg: 'Invalid user and Password', screen: '1'});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$App$checkUser = function (model) {
	return model;
};
...
var _user$project$App$init = A8(_user$project$App$Model, '', '', '', '', '', '', '', '1');
